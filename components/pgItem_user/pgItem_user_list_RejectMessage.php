...
function pgItem_user_list_RejectMessage( $rw ){
	...
	return "<div class=\"".__FUNCTION__."\"><div class=\"head\">پیام مدیریت سایت :‌</div><hr>".$rw_reject['text']."<hr><a class=\"btn btn-primary\" href=\"./?page=14&do=pgItem_user&do1=form&id=".$id."\">ویرایش</a></div>";
