...
<form id="user_forgot_new" method="post" action="{_URL}/<?=Slug::getSlugByName('forgot')?>" >
	...
	<input class="placeholder_fix" placeholder="<lang>کلمه عبور</lang>" autocomplete="new-password" type="password" id="password1" required />
